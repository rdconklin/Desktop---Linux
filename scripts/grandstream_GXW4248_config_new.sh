...
##############################################
##                                          ##
## GRANDSTREAM GXW4248 Configuration Script ##
##                                          ## 
##############################################
...
SID=$(curl --connect-timeout 10 -X POST -d "username=admin&password=admin" http://$GATEWAYIP/cgi-bin/dologin | grep -o 'sid" : ............' | tail -c 12)
...
#3rd Grandstream etc....
curl --connect-timeout 10 -X POST -d "P8=1&P9=192&P10=168&P11=3&P12=200&P13=255&P14=255&P15=255&P16=0&P17=192&P=168&P3=3&P20=100&sid=$SID" http://$GATEWAYIP/cgi-bin/api.values.post
...
curl --connect-timeout 10 -X POST -d "P47=192.168.3.100&P81=1&P850=101&P72=0&sid=$SID" http://$GATEWAYIP/cgi-bin/api.values.post
